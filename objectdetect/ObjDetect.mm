...
std::vector<ObjDetect::shapeDef> ObjDetect::loadImageSample(){
    
    std::vector<ObjDetect::shapeDef> samples;
...
ObjDetect::shapeDef ObjDetect::shape(cv::Mat image){
...
cv::Mat ObjDetect::getROI(cv::Mat image,ObjDetect::shapeDef *shape,int index,cv::Point *offset){
...
int ObjDetect::getMaxContour(ObjDetect::shapeDef *shape){
...
void ObjDetect::getCentroid(cv::Mat image,ObjDetect::shapeDef *shape,cv::Point offset){
...
double ObjDetect::compareShapes(ObjDetect::shapeDef *shape1,ObjDetect::shapeDef *shape2){
...
cv::Mat ObjDetect::compareAndShow(ObjDetect::shapeDef *shape1,ObjDetect::shapeDef *shape2){
...
cv::Mat ObjDetect::drawShape(ObjDetect::shapeDef shape,bool draw_centroids,bool maxContour){
...
bool ObjDetect::processFrame(const cv::Mat& inputFrame, cv::Mat& outputFrame,int const mode){
...
cv::Mat ObjDetect::imageSegmentation(cv::Mat image){
